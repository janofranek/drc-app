...
import { getScorecardId, setHoleScore } from "./Utils.js"


export const SkoreFlightAccHeader = (props) => {
  ...
  export const SkoreFlightAccBody = (props) => {
    const scorecardId = getScorecardId(props.currentRound.date, props.player)
    return (
      <Accordion.Body> 
  ...
  export const SkoreFlightTable = (props) => {
        ...
        <table className="flighttable">
          ...
          <tbody>
            <tr>
              ...
              {Object.keys(flightData).map((key) => { return <SkoreFlightCell holeSelect={holeSelect} data={flightData[key]} formData={formData} setFormData={setFormData}/>})}
              <td>
