  ...
  return (
    <>
      <tr key={props.counter}>
        ...
        <th key="DRTR" className="vertcenter text-center">{props.dataRow.totalScore}/{props.dataRow.totalStbl}</th>
      </tr>
  ...
  return (
    <>
      <tr key={props.counter}>
        ...
        {props.currTournament.rounds.map((round, index) => {
          return (<><td key={"R" + round.date + props.counter} className="align-middle">
            {props.dataRow[round.date + "_stbl"]}
          </td></>)
        })}
        <th key="DRTR" className="align-middle text-center">{props.dataRow.totalStbl}</th>
      </tr>
    </>
  )
}
